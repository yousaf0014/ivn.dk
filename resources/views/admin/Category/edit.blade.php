...
@section('content')
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            {{ Html::ul($errors->all()) }}
            {!! Form::model($category, array('url' => array('admin/Category/update', $category->id),'id'=>'add_content','files'=>'true','name'=>'add_content','class'=>'form-horizontal', 'method' => 'PUT')) !!}
                @include('admin.Category.formhtml');
            {!! Form::close() !!}
        </div>
    </div>
@endsection
