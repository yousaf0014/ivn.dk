    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <table style="width:100%" class="table table-bordered table-striped table-hover" cellspacing="0" cellpadding="5">
                <tr>
                    <td colspan="2"><img height="200" alt="No Image" src="{{asset('uploads/category/'.$category->image_path)}}"></td>
                </tr>
                <tr>        
                ...
                <tr>
                    ...
                    <td class="text-left"><?php echo html_entity_decode($category->details)?></td>
                </tr>
            </table>    
            <div class="clearfix"></div>
