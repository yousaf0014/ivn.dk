...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="col-lg-12">
                <div class="pull-left"><h3>Ad Management</h3></div>
                <div class="pull-right" style="color:black">
                    <form id="searchCompanies" name="searchSs" class="pull-right" action="{{url('admin/Ad')}}">
                        ...
                        <a href="{{url('admin/Ad/create/')}}" class="btn btn-warning btn-sm">Add Ad</a>                
                    </form>
                </div>
                ...
                <tr >
                    ...
                    <td class="text-center">
                        @if (!empty($cnt->image_path))
                            <img src="{{asset('uploads/Ad/'.$cnt->image_path)}}" width="150"  />
                        @else
                            N/A
                        @endif
                    </td>
                    <td class="text-center">
                        <a href="{{url('admin/Ad/'.$cnt->id.'/edit')}}" title="Edit Post" class="edit_info">
                            <span class="glyphicon glyphicon-pencil"></span></a> &nbsp;

                        <?php /*
                        {!! Form::open(array('url' => 'admin/Ad/' . $cnt->id ,'id'=>'delete_'.$cnt->id,'class' => 'pull-right')) !!}
                        ...
                        */?>
                        <?php if($cnt->active){ ?>
                            <a href="{{url('admin/Ad/delete/'.$cnt->id)}}/0" title="Delete">
                                <span class="glyphicon glyphicon-remove mr5"></span>
                            </a> &nbsp;
                        <?php }else{?>
                            <a href="{{url('admin/Ad/delete/'.$cnt->id)}}/0" title="Undo Delete">
                                <span class="glyphicon glyphicon-ok mr5"></span>
                            </a> &nbsp;                             
                        <?php } ?>

                        <a title="Preview" href="{{url('admin/Ad',$cnt->id)}}"><span class="glyphicon glyphicon-eye-open"></span></a>
                        &nbsp;
