...
@section('content')
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            {{ Html::ul($errors->all()) }}
            {!! Form::open(array('url' => 'admin/Package','id'=>'add_content','name'=>'add_content','files'=>'true','class'=>'form-horizontal')) !!}
                @include('admin.Package.formhtml');
            {!! Form::close() !!}
        </div>
    </div>
@endsection
    ...
    $(document).ready(function(){
        ...
        options = {
                ...
                messages: {
                    ...
                    'price':{'required':"Price is required",'number':'not a valid number'}
                }
            };
