...
@section('content')
    <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <a class="pull-right btn btn-danger btn-sm mt5" href="{{url('admin/Network/'.$category->id)}}">
        ...
        <div class="panel-body">
            <ol class="breadcrumb">         
                <li><a href="{{url('admin/Network')}}">Network</a></li>
                <li class="active">Add</a>
            </ol>
            {{ Html::ul($errors->all()) }}
            {!! Form::open(array('url' => 'admin/Network/'.$category->id,'id'=>'add_content','name'=>'add_content','files'=>'true','class'=>'form-horizontal')) !!}
                <input type="hidden" name="category_id" value="{{$category->id}}">
                @include('admin.Network.formhtml');
            {!! Form::close() !!}
        </div>
    </div>
@endsection
