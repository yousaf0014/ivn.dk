						...
						<div class="col-md-12">
							...
							<?php } ?>	
								...
								<div class="form-field">
									...
									<div class="field-element">
										<input type="text" name="CVR nr." placeholder="CVR nr." class="field-item" value="{{$user->cpr}}" required="true">
									</div>
								</div>
								...
								<div class="form-field">
									...
									<div class="field-element">
										<input type="text" name="Firmanavn" placeholder="Firmanavn" class="field-item" required="true" value="{{$user-> first_name }}">
									</div>
								</div>
								...
								<div class="form-field">
									...
									<div class="field-element">
										<input type="text" name="Adresse" placeholder="Adresse" class="field-item" required="true" value="{{$user->address}}">
									</div>
								</div>
								<div class="form-field">
									<label for="">Postnummer</label>
									<div class="field-element">
										<input type="text" name="Postnummer" placeholder="Postnummer" class="field-item" required="true" value="{{$user->zipcode}}">
									</div>
								</div>
								<div class="form-field">
									<label for="">By</label>
									<div class="field-element">
										<input type="text" name="By" placeholder="By" class="field-item" required="true" value="{{$user->city}}">
									</div>
								</div>
								<div class="form-field">
									<label for="">Telefon</label>
									<div class="field-element">
										<input type="text" name="Telefon" placeholder="Telefon" class="field-item" number minlength="8" maxlength="8" required="true" value="{{$user->mobile}}" >
									</div>
								</div>
								<div class="form-field">
								...
								<div class="form-field">
									...
									<div class="field-element">
										<input type="text" name="email" placeholder="E-mail" class="field-item" required="true" email="true" readonly="true" value="{{$user->email}}">
									</div>
								</div>
								<h2>Firmaoplysninger</h2>
								<p>
								...
								<div class="form-field">
									<label for="">&nbsp;</label>
									<div class="field-element">
										<input type="checkbox" name="Vi_har_abonnementsbetalinger" value="1" onchange="showHiddenlevering(0)">&nbsp;Vi har abonnementsbetalinger
									</div>
								</div>
								<div class="form-field">
									<label for="">&nbsp;</label>
									<div class="field-element">
										<input type="checkbox" name="Vi_har_fysisk_levering_af_varer" value="1" id="chekBoxlevering2" onchange="showHiddenlevering(1)">&nbsp;Vi har fysisk levering af varer
									</div>
								</div>
								<div class="clearfix" style="display:none;" id="Hiddenlevering">
									<div class="form-field">
										...
										<div class="field-element">
											<select name="Leveringstid" class="field-item">
								...
								<div class="form-field">
									...
									<div class="field-element">
										<div class="brdr-dashed-box">
											<p>Slip fil her eller vælg filer</p>
											<div class="clearfix"></div>
											<input type="file" name="slip" value="" placeholder="Fil">
										</div>
								...
								<?php if(!empty(Auth::user()) && \Auth::user()->user_subscription != 'level1'){ ?>
									<div class="form-field">
										<label for="">&nbsp;</label>
										<div class="field-element">										
											<input type="submit" onclick="sendbuttonTrack1('Tilmeldinger','tilmelding','PensoPay')" name="Send" />										
										</div>
									</div>
								</form>
								<?php }else{?>
									<div class="form-field">
										<label for="">&nbsp;</label>
										<div class="field-element">										
											<input type="submit" onclick="showpopup()" name="Send" />										
										</div>
									</div>
								<?php } ?>
						</div>
