                                ...
                                <div id="owl-carousel" class="owl-carousel">
                                    ...
                                    <div class="carousel-item">
                                        <div class="carousel-container1">
                                            <h3><?php echo cmskey('non_logedin_first_col_heading');?></h3>
                                            <div class="content">
                                                <?php echo cmskey('non_logedin_first_col_message');?>
                                            </div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="carousel-container2">
                                            <h3><?php echo cmskey('non_logedin_col2_heading');?></h3>
                                            <div class="content">
                                                <video width="100%" controls poster="{{asset('videos/jacobbundsgaard.png')}}" >
                                                    <source src="{{url('videos/jacobbundsgaard.mp4')}}" type="video/mp4">
                                                        <source src="{{url('videos/jacobbundsgaard.mp4')}}" type="video/ogg">
                                                            Your browser does not support the video tag.
                                                        </video> 
                                                    </div>
                                                    <p style="margin-left: 5px;"><?php echo cmskey('non_logedin_col2_text');?></p>
                                                </div>
                                            </div>
                                            <!-- 3rd carousel slider -->
                                            <div class="carousel-item">
                                                <div class="carousel-container3">
                                                    <h3><?php echo cmskey('non_logedin_col3_mainheading');?></h3>
                                                    <h4><?php echo cmskey('non_logedin_col3_subheading');?></h4>
                                                    <ul class="features">
                                                        <li><img src="{{asset('images/check.png')}}" height="33"><?php echo cmskey('non_logedin_col3_text1');?></li>
                                                        <li><img src="{{asset('images/check.png')}}" height="33"><?php echo cmskey('non_logedin_col3_text2');?></li>
                                                        <li><img src="{{asset('images/check.png')}}" height="33"><?php echo cmskey('non_logedin_col3_text3');?></li>
                                                    </ul>
