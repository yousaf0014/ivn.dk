        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xs-12 removeMobPadding">
                        ...
                        <div class="load_more" id="user_post_div">
                            <a class="nextPage" href="{{url('home/loadPages')}}/?option=user&page=<?php echo $feedFlag1 == true ? 2:3 ?>&file=home"><?php echo cmskey('load_more',true) ?></a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xs-12 removeMobPadding">
                        ...
                        <input type="hidden" value="<?php echo $feedFlag1 == true ? 2:4;?>" id="other_post_input">
                        <div class="load_more" id="other_load_more">
                            <a class="nextPage" href="{{url('home/loadPages')}}/?option=other&page=3&file=home"><?php echo cmskey('load_more',true) ?></a>
            ...
            <div class="col-sm-4 col-md-4 col-lg-4 content-rgt removeMobPadding">
                ...
                <div class="load_more" id="network_load_more">
                    <a class="nextPage" href="{{url('home/loadPages')}}/?option=network&page=3&file=home"><?php echo cmskey('load_more',true) ?></a>
            ...
            <?php }else{ ?>
                <div class="col-sm-4 col-md-4 col-lg-4 content-rgt removeMobPadding">
                    ...
                    <div class="load_more" id="network_load_more">
                        <a class="nextPage" href="{{url('home/loadPages')}}/?page=2&file=home"><?php echo cmskey('load_more',true) ?></a>
...
function loadmore(option,inputpage,imgID,divID,loadmorelink){
        ...
        $.ajax({
            url: "{{url('home/loadPages')}}",
            type: "post",
            data: {option:option,page:page,file:'home'},
            success: function(res){
                if(res == ''){
