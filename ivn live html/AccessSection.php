                            ...
                            <div class="col-lg-12 col-xs-12 text-center">
                                    ...
                                    <?php 
                                       ...
                                       $loginURL = $helper->getLoginUrl($redirectURL, $fbPermissions);
                                        echo '<a href="'.htmlspecialchars($loginURL).'" class="btn btn-fb btn-fb col-xs-8 col-xs-offset-2">Opret profil med Facebook</a>';
                                    ?>
                            </div>
                            <div class="clearfix"></div>
                            <!-- <div class="col-lg-12 text-center">
                                   <p> <a href="manual-merger.php">Allerede medlem? Flet din profil med Facebook her.</a></p>
                            </div> -->
                        </div>
