        ...
        <div class="swiper-slide"> 
            ...
            <div class="container" style="position:relative;">
                <div class="slider-box desktop">
                    <h1 class="no-margin">30.000 medlemmer kan ikke tage fejl</h1>
...
<?php 
    if(!$fb_login){
        ...
        $sql = "select * from users where email = '$fb_email' or fb_email = '$fb_email'";
    	...
    	<div class="container text-center">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <h4>Med 30.000 medlemmer er IVN.dk den mest fyldestg&oslash;rende platform for alt, der har med iv&aelig;rks&aelig;tteri at g&oslash;re.</h4>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('head').append('<meta name="description" content="IVN.dk er det n�ste skridt for facebook gruppen Iv�rks�tter Netv�rk. 30.000 medlemmer giver de bedst mulige vilk�r for at skabe en platform, der d�kker alle iv�rks�tteriets behov. Opret din personlige profil i dag og v�r med til at forme IVN.dk.">');
