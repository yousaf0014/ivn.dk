	...
	$action		= mysql_real_escape_string($_POST['action']);
		switch($action){
			...
			case 'CONTACT-US':
					...
					$to = 'info@ivn.dk';
					$subject =  'IVN | Besked';
					$message ="<p>Name: $contact_name</p>";
					$message.="<br><br><p>Email: $contact_email</p>";
					$message.="<br><br><p>Besked: $contact_msg</p>";
			...
			case 'SUBSCRIBE':
					...
					$message = '<p>Name:'.$sub_name.'<br><br>E-mail: '.$sub_email.'<br><br>Company Name: '.$sub_company.
					'</p>';
					$from = 'no-reply@ivn.dk';
				...
				case 'Second_Subscribe':
					...
					$message = 'Company: '.$sub_company;
					$message.='<br><br>Name: '.$sub_fulde;
					$message.='<br><br>E-mail: '.$sub_email;
					$message.='<br><br>CVR: '.$sub_cvr;
					$message.='<br><br>Website: '.$sub_hje;
					$message.='<br><br>Telephone: '.$sub_tel;
				...
				//geting variables
					...
					$message = '<p>Name:'.$name.'<br>E-mail: '.$email.'<br>Company Name: '.$company.'</p>';
					$from = 'no-reply@ivn.dk';
					generic_email_sender($to , $subject, $message,$from,THANKYOU_SIGNUP,EMAIL_ERROR);
				...
				case 'SUBSCRIBE_ENT':
					...
					$message = 'Name: '.$name;
					$message.='<br><br>Telephone:'.$phone;
					$message.='<br><br>E-mail:'.$email;
					$message.='<br><br>Company Name: '.$company;
					$message.='<br><br>Jeg vil gerne høre mere om:'.$more_about;
					$from = 'no-reply@ivn.dk';
