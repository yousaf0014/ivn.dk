                    ...
                    <h3 style="margin-bottom: 0px;">Skal vi kontakte dig?</h3>
                        ...
                        <div class="row m-t-20">
                            ...
                            <div class="radio radio-primary col-lg-10 col-lg-offset-1">
                                <div class="col-lg-6">
                                    <p> <input type="radio" checked="true" name="more_about" id="erhver" value="Erhvervsl&aring;n">
                                        <label for="erhver">&nbsp;&nbsp;Erhvervslån</label>
                                    </p>
                                </div>
                                <div class="col-lg-6">
                                    <p> <input type="radio" name="more_about" id="nervae" value="Netv&aelig;rksl&aring;n">
