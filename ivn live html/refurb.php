...
<div class="container">
       ...
       <div class="col-sm-12 col-lg-5 col-md-5 mobile_margin_top">
        <div class="login_point" id="login"></div>
                <div class="subscribe-wrapper dark-grey" style="position:relative">
                    <iframe style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;border:0px" allowfullscreen="true" >
                	<?php 
                    ...
                    <p>Pr&oslash;v det f&oslash;rste salgsm&oslash;de gratis.</p>
                        ...
                        <div class="row m-t-20">
                        	...
                        	<div class="col-lg-8 col-lg-offset-2">
                            	<button type="submit" class="btn btn-primary col-lg-12" onclick="sendbuttonTrack1('Tilmeldinger','tilmelding','VirtuelSalgschef');">
