...
<section>
        ...
        <div class="fill mobile" style="background-image:url('images/ivn-jura.png');"></div>
        <div class="desktop"><img src="images/ivn-jura.png" style="max-height:551px;"/></div>
</section>
    ...
    <div class="container">    
      <div class="row">
        	<div class="col-lg-12 text-center">
            	<h1>Få svar på dine juridiske spørgsmål</h1>
            </div>
      </div><!--/row-->
    </div><!--Container-->
