...
<div class="swiper-container" style="padding-top:80px;">
    ...
    <div class="swiper-wrapper">
        <!-- Slides -->
        <div  calass="swiper-slide" style="width: 100%;">
             <div calass="item active slide-2 animated slideInRight">
                <div calass="fill mobile" style="background-image:url('assets/images/slider-2.jpg');"></div>
                <?php if($mobile){?>
                <img src="assets/images/slider-2_mobile.png" style="width:100%"/>
                <?php }else{?>
