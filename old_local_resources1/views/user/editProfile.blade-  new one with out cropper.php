            		...
            		{!! Form::open(array('url' => 'editProfile','id'=>'add_content','name'=>'add_content','files'=>'true','class'=>'form-horizontal')) !!}
						...
						<div class="form-field">
							...
							<select name="c_Entrepreneurial_status" id="" class="form-control">
								<option value=""></option>
								<option value="Enkeltmandsvirksomhed" <?php echo !empty($company) && $company->entrepreneurial_status == 'Enkeltmandsvirksomhed' ? 'selected="selected"':'';?>>Enkeltmandsvirksomhed</option>
								<option value="2-5" <?php echo !empty($company) && $company->entrepreneurial_status == '2-5' ? 'selected="selected"':'';?>>2-5</option>
								<option value="6-10" <?php echo !empty($company) && $company->entrepreneurial_status == '6-10' ? 'selected="selected"':'';?>>6-10</option>
								<option value="11-20" <?php echo !empty($company) && $company->entrepreneurial_status == '11-20' ? 'selected="selected"':'';?>>11-20</option>
								<option value="20+" <?php echo !empty($company) && $company->entrepreneurial_status == '20+' ? 'selected="selected"':'';?>>20+</option>
							</select>
						</div>
...
@endsection
@section('scripts')
<link href="{{asset('css/imgareaselect.css?v=1')}}" media="screen" rel="stylesheet" type="text/css">
<script src="{{asset('js/jquery.imgareaselect.js?v=1')}}" ></script>
