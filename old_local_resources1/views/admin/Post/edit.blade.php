...
@section('content')
    <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <a class="pull-right btn btn-danger btn-sm mt5" href="{{url('admin/Post')}}">
                <span class="glyphicon glyphicon-circle-arrow-left"></span>&nbsp;Go Back
            </a>        
            <a href="javascript:;" onclick="submitPost()" class="btn btn-warning pull-right btn-sm mt5 mr10" style="margin-right:5px;">Save</a>    
        ...
        <div class="panel-body">
            ...
            {{ Html::ul($errors->all()) }}
            {!! Form::model($post, array('url' => array('admin/Post/update', $post->id),'id'=>'add_content','files'=>'true','name'=>'add_content','class'=>'form-horizontal', 'method' => 'PUT')) !!}
                @include('admin.Post.formhtml');
            {!! Form::close() !!}
        </div>
    </div>
@endsection
