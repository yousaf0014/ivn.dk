...
<div class="form-group">
    <label class="col-md-2  control-label" for="profilePic">Post Pic</label>
    <div class="col-md-10">
        <?php $path =  !empty($post)? asset('uploads/Post/' . $post->image_path) :'';?>
        <div id="profile-pic">
...
<div class="form-group">
    <label class="col-lg-2 control-label">Is News</label>
    <div class="col-lg-10">
        {!! Form::checkbox('is_news', 1) !!}        
    </div>
</div>
<div class="form-group">
    <label class="col-lg-2 control-label">Tags</label>
    <div class="col-lg-10">
        <select multiple type="text" data-role="tagsinput" name="tags[]" id="tags" class="form-control input-sm">
        </select>          
    </div>
</div>
<div class="form-group">
...
<div class="form-group">                
    <div class="col-lg-offset-1 col-lg-1">
        <a class="pull-right btn btn-danger" href="{{url('admin/Post')}}">
        <span class="glyphicon glyphicon-circle-arrow-left"></span>&nbsp;Go Back</a>
    </div>
    <div class="col-lg-offset-1">
        <button type="button" onclick="submitPost()" class="btn btn-warning btn-sm">Save</button>                                    
    </div>
</div>