 <div class="panel panel-primary">
    ...
    <div class="panel-body">
        {!! Form::open(array('url' => 'admin/Category/uploadImage/'.$category->id,'id'=>'add_image','name'=>'add_image','files'=>'true','class'=>'form-horizontal')) !!}
        <div class="form-group">
            <label for="inputName" class="col-lg-2 control-label">Select Pic</label>
            <div class="col-lg-10">
                <input type="file" name="image_path" id="image" size="17" />
            </div>
        </div>
        <div class="clearfix"></div>
        <div class="form-group">
