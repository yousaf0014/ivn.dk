...
@section('content')
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <ol class="breadcrumb">         
                <li><a href="{{url('admin/business')}}">Ad</a></li>
                <li class="active">Add</a>
            </ol>
            {{ Html::ul($errors->all()) }}
            {!! Form::model($post, array('url' => array('admin/Ad/update', $post->id),'id'=>'add_content','files'=>'true','name'=>'add_content','class'=>'form-horizontal', 'method' => 'PUT')) !!}
                @include('admin.Ad.formhtml');
            {!! Form::close() !!}
        </div>
    </div>
@endsection
