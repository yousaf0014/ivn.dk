				...
				<div class="cards-lists-with-thumb">
					...
					<div class="card-content">
						...
						<div class="ref-link-box">
							...
							<div class="inLink btnRight"><a target="_blank"  href="{{cmskey('bdo_button_1_link',true)}}"><?php echo cmskey('bdo_page_link_title1');?></a></div>
						</div>
					</div>
				</div>
				...
				<div class="cards-lists-with-thumb">
					...
					<div class="card-content">
						...
						<div class="ref-link-box">
							...
							<div class="inLink btnRight"><a target="_blank"  href="{{cmskey('bdo_button_2_link',true)}}"><?php echo cmskey('bdo_page_link_title2');?></a></div>
						</div>
					</div>
				...
				<div class="cards-lists-with-thumb">
					...
					<div class="card-content">
						...
						<div class="ref-link-box">
							...
							<div class="inLink btnRight"><a target="_blank"  href="{{cmskey('bdo_button_3_link',true)}}"><?php echo cmskey('bdo_page_link_title3');?></a></div>
						</div>
					</div>
				</div>
				...
				<div class="cards-lists-with-thumb">
					...
					<div class="card-content">
						...
						<div class="ref-link-box">
							...
							<div class="inLink btnRight"><a target="_blank"  href="{{cmskey('bdo_button_4_link',true)}}"><?php echo cmskey('bdo_page_link_title4');?></a></div>
						</div>
					</div>
				...
				<div class="cards-lists-with-thumb" style="display:none;">
					...
					<div class="card-content">
						...
						<div class="ref-link-box">
							...
							<div class="inLink btnRight"><a target="_blank"  href="{{cmskey('bdo_button_5_link',true)}}"><?php echo cmskey('bdo_page_link_title5');?></a></div>
						</div>
					</div>
				</div>
				...
				<div class="cards-lists-with-thumb" style="display:none;">
					<div class="card-content">
						...
						<div class="ref-link-box">
							...
							<div class="inLink btnRight"><a target="_blank"  href="{{cmskey('bdo_button_6_link',true)}}"><?php echo cmskey('bdo_page_link_title6');?></a></div>
						</div>
					</div>
					...
					//if(Auth::user()->user_subscription == 'level3'){ ?>
						...
						<div class="frm-row">
							<div class="list-content">
								...
								<?php if(Auth::user()->user_subscription != 'level1'){ ?>
								...
								<?php } else { ?>
								<div class="opt-abs-txt">
									<span class="circle" id="red1" onclick="showpopup()"><input style="display:none;" type="radio" name="red1" id="r_red1" value="1"></span>
									<span class="txt"><a href="javascript:;" onclick="showpopup()" style="color:white;text-decoration:underline;">Ja tak</a></span>
								</div>
								<?php } ?>
							</div>
							<div class="list-content">
								...
								<?php if(Auth::user()->user_subscription == 'level3'){ ?>
								<div class="opt-abs-txt">
								...
								<?php } else { ?>
								<div class="opt-abs-txt">
									<span class="circle"  id="red2" onclick="showpopup()"><input style="display:none;" type="radio" name="red2" id="r_red2" value="1"></span>
									<span class="txt"><a href="javascript:;" onclick="showpopup()" style="color:white;text-decoration:underline;">Ja tak</a></span>
								</div>
								<?php } ?>
							</div>
