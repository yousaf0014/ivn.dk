								...
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											...
											<li><a href=" https://itunes.apple.com/dk/podcast/morten-resen-startup/id1112082865?l=da&mt=2" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
								...
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											...
											<li><a href="https://itunes.apple.com/dk/podcast/solopreneurcast/id914063619?l=da&mt=2&ls=1" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
								...
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											...
											<li><a href="https://itunes.apple.com/dk/podcast/rasmus-holmgaard-startup-podcast/id1232191597?l=da&mt=2" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
								...
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											...
											<li><a href="https://itunes.apple.com/dk/podcast/born-global/id1347170921?l=da&mt=2" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
								...
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											...
											<li><a href="https://itunes.apple.com/dk/podcast/help-marketing/id926207630?mt=2&ls=1" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
								...
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											...
											<li><a href="https://itunes.apple.com/dk/podcast/succes-kriteriet/id1164472064?l=da&mt=2" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
								...
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											...
											<li><a href="https://itunes.apple.com/dk/podcast/startup-podcast/id913805339?l=da&mt=2" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
								...
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											...
											<li><a href="https://itunes.apple.com/us/podcast/entrepreneuronfire.com-inspiring/id564001633" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
								...
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											...
											<li><a href="https://itunes.apple.com/dk/podcast/youpreneur-fm-how-to-build-market-monetize-grow-successful/id590043753?l=da&mt=2" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
								...
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											...
											<li><a href="https://itunes.apple.com/dk/podcast/den-digitale-nomade/id1237572292?l=da&mt=2" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
						...
						<div class="main-box">
							...
							<div class="div-set">
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											<li><a href="https://www.radio24syv.dk/programmer/de-6-hatte" target="_blank"><img width="50px;" src="{{asset('images/business-units/ivn-podconsult-www.png')}}"></a></li>
											<li><a href="https://arkiv.radio24syv.dk/audiopodcast/channel/3843764" target="_blank"><img width="25px;" style="margin-left:10px" src="{{asset('images/business-units/ivn-podconsult-rss-feed.png')}}"></a></li>
											<li><a href="https://itunes.apple.com/dk/podcast/de-6-hatte/id485306395?l=da&mt=2" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
						...
						<div class="main-box">
							...
							<div class="div-set">
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											<li><a href="https://workflow.fireside.fm/" target="_blank"><img width="50px;" src="{{asset('images/business-units/ivn-podconsult-www.png')}}"></a></li>
											<li><a href="https://workflow.fireside.fm/rss" target="_blank"><img width="25px;" style="margin-left:10px" src="{{asset('images/business-units/ivn-podconsult-rss-feed.png')}}"></a></li>
											<li><a href="https://itunes.apple.com/dk/podcast/work-flow-med-anders-h%C3%B8eg-nissen/id1232029837?mt=2" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
						...
						<div class="main-box">
							...
							<div class="div-set">
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											<li><a href="https://mastersofscale.com/" target="_blank"><img width="50px;" src="{{asset('images/business-units/ivn-podconsult-www.png')}}"></a></li>
											<li><a href="https://rss.art19.com/masters-of-scale" target="_blank"><img width="25px;" style="margin-left:10px" src="{{asset('images/business-units/ivn-podconsult-rss-feed.png')}}"></a></li>
											<li><a href="https://itunes.apple.com/WebObjects/MZStore.woa/wa/viewPodcast?id=1227971746&mt=2&ls=1" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
						...
						<div class="main-box">
							...
							<div class="div-set">
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											<li><a href="http://bizchix.com/" target="_blank"><img width="50px;" src="{{asset('images/business-units/ivn-podconsult-www.png')}}"></a></li>
											<li><a href="http://bizchix.libsyn.com/rss" target="_blank"><img width="25px;" style="margin-left:10px" src="{{asset('images/business-units/ivn-podconsult-rss-feed.png')}}"></a></li>
											<li><a href="https://itunes.apple.com/dk/podcast/bizchix-podcast-female-entrepreneurs-women-in-business/id811105481?l=da&mt=2" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
						...
						<div class="main-box">
							...
							<div class="div-set">
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											<li><a href="http://www.ivaerksaetterpodcast.dk/" target="_blank"><img width="50px;" src="{{asset('images/business-units/ivn-podconsult-www.png')}}"></a></li>
											<li><a href="http://ipodcast.libsyn.com/rss" target="_blank"><img width="25px;" style="margin-left:10px" src="{{asset('images/business-units/ivn-podconsult-rss-feed.png')}}"></a></li>
											<li><a href="https://itunes.apple.com/dk/podcast/iv-rks-tter-podcast-interviews/id896381058?l=da&mt=2" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
						...
						<div class="main-box">
							...
							<div class="div-set">
								<div class="col-xs-4">
									...
									<div class="icons">
										<ul>
											<li><a href="http://startupsnakken.dk/" target="_blank"><img width="50px;" src="{{asset('images/business-units/ivn-podconsult-www.png')}}"></a></li>
											<li><a href="http://startupsnakken.dk/feed/podcast/" target="_blank"><img width="25px;" style="margin-left:10px" src="{{asset('images/business-units/ivn-podconsult-rss-feed.png')}}"></a></li>
											<li><a href="https://itunes.apple.com/us/podcast/id1050429308" target="_blank"><img width="18px;" src="{{asset('images/business-units/ivn-podconsult-apple-logo.png')}}"></a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-8 ">
