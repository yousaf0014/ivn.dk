                                ...
                                <div class="slide-ad-post">
                                    <?php if(!empty($business)){?>
                                        ...
                                        <div class="rgt">
                                            ...
                                            <div class="desc">
                                                <?php echo shortString($business->description,150); ?>
                                            </div>
                                            <div class="link">
                                                <?php if(Auth::user()){ ?>
                        ...
                        <div class="profile-information">
                            ...
                            <div class="col-xs-12 col-sm-6 text-center elmnt-full">
                                ...
                                <div class="visible-xs text-center elmnt-shwng" style="display:block !important">
                                    <div class="user-address">
                                        <a style="color:white;text-decoration: underline;" onclick="trackNavigate('Subscription','{{url("subscription")}}')" href="javascript:;">Skift abonnement</a>
                                        <br>
